...
class TrashedNotesPage extends StatefulWidget {
  const TrashedNotesPage(
      {super.key,
      required this.auth,
  ...
  @override
  State<TrashedNotesPage> createState() => _TrashedNotesPageState();
}

class _TrashedNotesPageState extends State<TrashedNotesPage> {
                        ...
                        builder:
                          ...
                          if (snapshot.hasData &&
                            ...
                            for (var note in snapshot.data!.docs) {
                              var map = note.data() as Map<String, dynamic>;
                              _noteIds.add(map['id']);
                            }
                                      ...
                                      onPressed: () {
                                        ...
                                        showDialog(
                                          ...
                                          builder: (BuildContext context) =>
                                            ...
                                            content: const Text(
                                              "Do you really want to delete all the trashed notes?",
                                              style: TextStyle(
                                                color: Colors.white,
                                                fontSize: 17,
                                              ),
